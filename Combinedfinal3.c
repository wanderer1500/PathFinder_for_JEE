...
void collegedetails()
{
    ...
    while (t)
    {
        ...
        printf("\t\t\t\t\t||\t\t\t|\t\033[1;31mMain Menu        \033[1;0m|  \033[1;34m24   \033[1;0m|\t\t\t||\n");
...
void answering(int choice, int k, struct answers anss[], time_t begin)
{
    ...
    {   int checko = timer(begin);
        ...
        printf("\nQuestion %d: ", i + 1);
        scanf("%c", &anss[choice - 1].sat[i + k * 4]);
        fflush(stdin);
    }
    printf("\033[4;31m\n\n\t\t\t\tSECTION 2\n\033[1;0m");
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        printf("\nQuestion %d: ", i + 1);
        scanf("%d", &anss[choice - 1].itype[i + k * 3]);
        fflush(stdin);
    }
    printf("\033[4;31m\n\n\t\t\t\tSECTION 4\n\033[1;0m");
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        printf("\nQuestion %d: ", i + 1);
        scanf("%f", &anss[choice - 1].numer[i + k * 4]);
        fflush(stdin);
    }
}
...
start1:
    ...
    {
        int czx;
        printf("\033[1;31mWrong password. Enter 1 to return to Main Section Else Enter 0\033[1;0m");
        scanf("%d", &czx);
        if (czx == 1)
        {
            loginregisterpage();
